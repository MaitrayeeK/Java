...
public class ANSIMatching extends javax.swing.JDialog {

    /** Creates new form ANSIMatching */
    public ANSIMatching(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ANSIMatching dialog = new ANSIMatching(new javax.swing.JFrame(), true);
